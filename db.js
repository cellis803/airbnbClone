        ...
        return new Promise(
            (resolve, reject) => {
                db.serialize(function () {
                    ...
                    db.run("INSERT INTO listing VALUES (4,'akashPandya@gmail.com','Cricket Hangout','room',1,1,1,'222 Bowler Lane','','London','','90909','GBR','0108882234555','100','one week','img4.jpg',0,0)");
